...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Toes', 'toes', 'I kill frogs before but Idk what else :skull:', 'https://www.youtube.com/channel/UCbl9q0vhZEYc0u4aQb92xyQ', 'FF0000'],
			['Minimique', 'mini', 'Placeholder Text', 'https://www.youtube.com/@gamesvideos6409', 'FF0000'],
